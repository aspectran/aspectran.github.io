...
작고 빠른 프레임워크를 만들기 위해 잘 알려진 범용 라이브러리에 의존하기 보다는 최적화 된 기능을 직접 구현하는데 중점을 두었습니다.
...
이제 품 안에만 있던 이 것을 세상 밖으로 내 보내려고 합니다. 
정식 버전 출시와 함께 오픈소스로 공개하오니 여러분과 함께 만들어 가는 Aspectran이 되기를 바랍니다. 
