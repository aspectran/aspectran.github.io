...
shell: {
    ...
    greetings: (
        ...
        |
        |{{gray   }}To see a list of all built-in commands, type {{GREEN}}help.
        |{{gray   }}To get help for a specific command, type {{GREEN}}command_name -h.
        |{{gray   }}To list all available translets, type {{CYAN}}translet -l.
