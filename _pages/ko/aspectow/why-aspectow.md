...
Aspectow는 기존 솔루션들의 단점을 보완하고, 고성능 서블릿/비-서블릿 웹 서버 기능과 함께 클러스터 관리, 원격 명령 센터, 분산 스케줄링, PBE 보안 Vault 및 실시간 AppMon 모니터링을 단일 통합 웹 콘솔(**Aspectow Console**) 형태로 완벽하게 통합 제공합니다.
