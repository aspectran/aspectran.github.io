...
|----------|-------------|---------|----------|
| com.aspectran | [aspectran][3] | [2.2.1][4] | [pom][5] [jar][6] [javadoc (jar)][7] [sources (jar)][8] |
...
[4]: http://search.maven.org/#artifactdetails|com.aspectran|aspectran|2.2.1|jar
[5]: http://search.maven.org/remotecontent?filepath=com/aspectran/aspectran/2.2.1/aspectran-2.2.1.pom
[6]: http://search.maven.org/remotecontent?filepath=com/aspectran/aspectran/2.2.1/aspectran-2.2.1.jar
[7]: http://search.maven.org/remotecontent?filepath=com/aspectran/aspectran/2.2.1/aspectran-2.2.1-javadoc.jar
[8]: http://search.maven.org/remotecontent?filepath=com/aspectran/aspectran/2.2.1/aspectran-2.2.1-sources.jar
