...
|----------|-------------|---------|----------|
| com.aspectran | [aspectran][3] | [2.3.0][4] | [pom][5] [jar][6] [javadoc (jar)][7] [sources (jar)][8] |
...
[4]: http://search.maven.org/#artifactdetails|com.aspectran|aspectran|2.3.0|jar
[5]: http://search.maven.org/remotecontent?filepath=com/aspectran/aspectran/2.3.0/aspectran-2.3.0.pom
[6]: http://search.maven.org/remotecontent?filepath=com/aspectran/aspectran/2.3.0/aspectran-2.3.0.jar
[7]: http://search.maven.org/remotecontent?filepath=com/aspectran/aspectran/2.3.0/aspectran-2.3.0-javadoc.jar
[8]: http://search.maven.org/remotecontent?filepath=com/aspectran/aspectran/2.3.0/aspectran-2.3.0-sources.jar
